...
python3 eval_decoding.py \
    -checkpoint checkpoints/decoding/best/task1_task2_taskNRv2_finetune_BrainTranslator_skipstep1_b32_20_30_2e-05_2e-05_unique_sent_EEG.pt \
    -conf config/decoding/task1_task2_taskNRv2_finetune_BrainTranslator_skipstep1_b32_20_30_2e-05_2e-05_unique_sent_EEG.json \
    -test_input EEG \
    -train_input EEG \
    -cuda cuda:0
